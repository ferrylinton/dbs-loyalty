...
public class LogTokenController {
	...
	private static final String REDIRECT 	= "redirect:/logtoken";
	
	private static final String VIEW 		= "logtoken/logtoken-view";
	...
	public String viewLogTokens(
		...
		Page<LogToken> page = logTokenService.findAll(params, PageUtil.getPageable(params, order));
