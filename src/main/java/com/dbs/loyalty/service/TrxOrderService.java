...
import com.dbs.loyalty.service.specification.TrxOrderSpec;
...
public class TrxOrderService{
	...
	public Page<TrxOrder> findAll(Map<String, String> params, Pageable pageable) {
		return trxOrderRepository.findAll(new TrxOrderSpec(params), pageable);
	}
