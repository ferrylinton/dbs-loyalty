...
public class MedicalProviderSpec implements Specification<MedicalProvider>{
...
private static final long serialVersionUID = 1L;
	...
	@Override
	public Predicate toPredicate(Root<MedicalProvider> root, CriteriaQuery<?> cq, CriteriaBuilder cb) {
		...
		if(params.containsKey(Constant.KY_PARAM) && !Constant.EMPTY.equals(params.get(Constant.KY_PARAM))) {
			...
			predicates.add(cb.like(cb.lower(root.get(DomainConstant.NAME)), keyword));
		}
