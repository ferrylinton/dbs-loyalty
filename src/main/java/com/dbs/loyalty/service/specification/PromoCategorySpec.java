...
public class PromoCategorySpec implements Specification<PromoCategory>{
	...
	@Override
	public Predicate toPredicate(Root<PromoCategory> root, CriteriaQuery<?> cq, CriteriaBuilder cb) {
