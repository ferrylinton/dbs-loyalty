...
public class PriviledgeProductSpec implements Specification<PriviledgeProduct>{
	...
	@Override
	public Predicate toPredicate(Root<PriviledgeProduct> root, CriteriaQuery<?> cq, CriteriaBuilder cb) {
